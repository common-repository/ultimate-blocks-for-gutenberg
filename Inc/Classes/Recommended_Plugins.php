	...
	class Recommended_Plugins extends Recommended {
		...
		public function plugins_list() {
			return array(
				...
				'copy-to-clipboard'     => array(
					...
					'short_description' => 'Copy To Clipboard is a WordPress plugin that makes it simple to copy & paste text, paragraphs, blockquotes, coupons codes and source codes from your WP website with a single click.',
		...
		public function admin_menu() {
			...
			$this->sub_menu = add_submenu_page(
				'jlt-master-blocks',       // Ex. ultimate-blocks-for-gutenberg-settings /  edit.php?post_type=page .
				__( 'Recommended', 'ultimate-blocks-for-gutenberg' ),
				__( 'Recommended', 'ultimate-blocks-for-gutenberg' ),
				'manage_options',
				'ultimate-blocks-for-gutenberg-recommended-plugins',
