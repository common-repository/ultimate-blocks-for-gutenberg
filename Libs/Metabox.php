...
{
	add_meta_box('hello_gutenberg_meta_box', __('Hello Gutenberg Meta Box', 'ultimate-blocks-for-gutenberg'), 'hello_gutenberg_metabox_callback', 'post',  array(
...
?>
	<label for="hello_gutenberg_field"><?php _e('What\'s your name?', 'ultimate-blocks-for-gutenberg') ?></label>
